        ...
        <div class="grid gap-2 sm:grid-cols-12 sm:gap-6">
          ...
          <div class="sm:col-span-9">
            <div class="flex items-center gap-5">
              ...
              <img class="inline-block rounded-full size-16 ring-2 ring-white dark:ring-neutral-900" src="{{ asset ('storage/profile/'.$user->photo_profile) }}" alt="Image Description">
              @endif
          ...
          <div class="sm:col-span-9">
            <input name="email" id="af-account-email" type="email" class="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg shadow-sm pe-11 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700  text-gray-800 mt-2.5 dark:text-neutral-200 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="maria@site.com" value="{{ $user->email }}">
            @error('email')
            <span class="text-red-400">{{ $message }}</span>
          @enderror
        </div>
          ...
          <div class="sm:col-span-9">
            <div class="space-y-2">
              ...
              <span>Kosongkan, Jika anda tidak akan mengganti Password</span>
              @error('password')
              <span class="text-red-400">{{ $message }}</span>
            @enderror
            </div>
          ...
          <div class="sm:col-span-9">
            <select name="roles" id="roles" class="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg shadow-sm pe-11 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
              @foreach ($roles as $role)
                <option value="{{$role->id}}" @if ($role->id == $user->roles)
                  selected
          ...
          <div class="sm:col-span-9">
            <textarea name="address" id="af-account-bio" class="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700  text-gray-800 mt-2.5 dark:text-neutral-200 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" rows="6" placeholder="Alamat..." >{{ $user->address }}</textarea>
        </div>
          <!-- End Col -->
        </div>
        <!-- End Grid -->
